...
namespace Gommon
{
    ...
    public class Guard 
    {
        ...
        public static void Matches([NotNull] string input, [NotNull] string regex, [CanBeNull] string name = null)
        {
            ...
            Ensure(new Regex(regex).IsMatch(input), $"{name ?? "Input"} must match regex ^{regex}$. Provided: \"{input}\"");
        }
        ...
        [Contract("null => halt")]
        public static void Require(object value) => new Possible<object>(value).OrThrow();
        [Contract("value:null => halt")]
        public static void Require(object value, string name) => new Possible<object>(value).OrThrow(() => new ValueException($"{name} must not be null."));
    }
    ...
    public class ValueException : Exception
    {
        ...
        public ValueException(string message = null, Exception innerException = null) : base("", innerException) { }
    }
